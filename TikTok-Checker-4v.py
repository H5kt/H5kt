...
db   db   ooooo db   dD d888888b 
88   88  8P~~~~ 88 ,8P' `~~88~~' 
88ooo88 dP      88,8P      88    
88~~~88 V8888b. 88`8b      88    
88   88     `8D 88 `88.    88    
YP   YP 88oobY' YP   YD    YP  
...
if falah == "3":
    ...
    for password in password:
        ...
        if 'user' in post:
            count += 1
            print(green_color + "{}: {}".format(count, W + password.strip()) + BRed + " | Not Available  ")
            with open('accountfound.txt', 'a') as x:
                x.write(password + '\n')
        else:
            count += 1
            print(green_color + "{}: {}".format(count, W + password.strip()) + Green + " |  Available  ")
